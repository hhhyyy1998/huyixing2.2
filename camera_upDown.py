from check_upDown import Check_upDown
from rknn_upDown import *
...
if camera:
    ...
    video = cv2.VideoCapture('../upDown.avi')
...
def drawing(frame_queue, detections_queue, prev_time_queue):
    ...
    while flag:
        ...
        if show:
            ...
            if cv2.waitKey(int(1 / (time.time() - prev_time))+20) == 27:
                flag = False
                break
